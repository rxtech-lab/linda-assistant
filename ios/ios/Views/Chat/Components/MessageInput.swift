...
struct MessageInput: View {
    ...
    var body: some View {
            ...
            if isStreaming {
                Button {
                    ...
                    Image(systemName: "stop.fill")
                        ...
                        .glassEffect(.regular.tint(Color(red: 0.95, green: 0.6, blue: 0.6).opacity(0.3)).interactive(), in: .circle)
                }
                .buttonStyle(.plain)
                .padding(.trailing, 8)
            } else {
        ...
        .shadow(color: isStreaming ? gradientColors[Int(borderAnimationProgress * 7) % 8].opacity(0.4) : .clear, radius: 12, x: 0, y: 0)
        .padding(.horizontal)
        .padding(.vertical, 8)
