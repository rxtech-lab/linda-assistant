...
# Safe to run locally when variables are not set.
...
# Support the variable name used in the skill docs and a repo-specific name.
decode_to_file "${RXSTORAGE_TESTING_SECRETS:-${LINDA_TESTING_SECRETS:-}}" \
